...
#include "unknown/Support/GraphWriter.h"
...
#include "unknown/Support/Program.h"
...
std::string unknown::DOT::EscapeString(const std::string &Label) {
...
StringRef unknown::DOT::getColorString(unsigned ColorNumber) {
...
std::string unknown::createGraphFilename(const Twine &Name, int &FD) {
  FD = -1;
...
bool unknown::DisplayGraph(StringRef FilenameRef, bool wait,
