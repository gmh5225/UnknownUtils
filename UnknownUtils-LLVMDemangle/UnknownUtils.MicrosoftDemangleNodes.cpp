...
static void
outputSpaceIfNecessary(OutputStream &OS)
{
    if (OS.empty())
        return;
...
static bool
outputSingleQualifier(OutputStream &OS, Qualifiers Q)
{
    switch (Q)
    {
    case Q_Const:
...
static bool
outputQualifierIfPresent(OutputStream &OS, Qualifiers Q, Qualifiers Mask, bool NeedSpace)
{
    if (!(Q & Mask))
        return NeedSpace;
...
static void
outputQualifiers(OutputStream &OS, Qualifiers Q, bool SpaceBefore, bool SpaceAfter)
{
    if (Q == Q_None)
        return;
...
static void
outputCallingConvention(OutputStream &OS, CallingConv CC)
{
...
std::string
Node::toString(OutputFlags Flags) const
{
    OutputStream OS;
...
void
TypeNode::outputQuals(bool SpaceBefore, bool SpaceAfter) const
{
}

void
PrimitiveTypeNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
    switch (PrimKind)
    {
...
void
NodeArrayNode::output(OutputStream &OS, OutputFlags Flags) const
{
    output(OS, Flags, ", ");
}

void
NodeArrayNode::output(OutputStream &OS, OutputFlags Flags, StringView Separator) const
{
    if (Count == 0)
        return;
    if (Nodes[0])
...
void
EncodedStringLiteralNode::output(OutputStream &OS, OutputFlags Flags) const
{
    switch (Char)
    {
    case CharKind::Wchar:
...
void
IntegerLiteralNode::output(OutputStream &OS, OutputFlags Flags) const
{
    if (IsNegative)
        OS << '-';
    OS << Value;
...
void
TemplateParameterReferenceNode::output(OutputStream &OS, OutputFlags Flags) const
{
...
void
IdentifierNode::outputTemplateParameters(OutputStream &OS, OutputFlags Flags) const
{
    if (!TemplateParams)
        return;
    OS << "<";
...
void
DynamicStructorIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    if (IsDestructor)
...
void
NamedIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    OS << Name;
...
void
IntrinsicFunctionIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    switch (Operator)
    {
...
void
LocalStaticGuardIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
...
void
ConversionOperatorIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    OS << "operator";
    outputTemplateParameters(OS, Flags);
    OS << " ";
...
void
StructorIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    if (IsDestructor)
        OS << "~";
...
void
LiteralOperatorIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    OS << "operator \"\"" << Name;
    outputTemplateParameters(OS, Flags);
}
...
void
FunctionSignatureNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
...
void
FunctionSignatureNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
...
void
ThunkSignatureNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
    OS << "[thunk]: ";
...
void
ThunkSignatureNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
...
void
PointerTypeNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
...
void
PointerTypeNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
...
void
TagTypeNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
...
void
TagTypeNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
}

void
ArrayTypeNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
...
void
ArrayTypeNode::outputOneDimension(OutputStream &OS, OutputFlags Flags, Node *N) const
{
...
void
ArrayTypeNode::outputDimensionsImpl(OutputStream &OS, OutputFlags Flags) const
{
...
void
ArrayTypeNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
    OS << "[";
...
void
SymbolNode::output(OutputStream &OS, OutputFlags Flags) const
{
    Name->output(OS, Flags);
}

void
FunctionSymbolNode::output(OutputStream &OS, OutputFlags Flags) const
{
...
void
VariableSymbolNode::output(OutputStream &OS, OutputFlags Flags) const
{
    switch (SC)
    {
...
void
CustomTypeNode::outputPre(OutputStream &OS, OutputFlags Flags) const
{
    Identifier->output(OS, Flags);
}
void
CustomTypeNode::outputPost(OutputStream &OS, OutputFlags Flags) const
{
}

void
QualifiedNameNode::output(OutputStream &OS, OutputFlags Flags) const
{
    Components->output(OS, Flags, "::");
}

void
RttiBaseClassDescriptorNode::output(OutputStream &OS, OutputFlags Flags) const
{
...
void
LocalStaticGuardVariableNode::output(OutputStream &OS, OutputFlags Flags) const
{
    Name->output(OS, Flags);
}

void
VcallThunkIdentifierNode::output(OutputStream &OS, OutputFlags Flags) const
{
    OS << "`vcall'{" << OffsetInVTable << ", {flat}}";
}

void
SpecialTableSymbolNode::output(OutputStream &OS, OutputFlags Flags) const
{
