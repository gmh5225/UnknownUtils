...
using namespace unknown::itanium_demangle;
...
const char *
itanium_demangle::parse_discriminator(const char *first, const char *last)
{
...
void
itanium_demangle::Node::dump() const
{
    DumpVisitor V;
    visit(std::ref(V));
    V.newLine();
...
char *
unknown::itaniumDemangle(const char *MangledName, char *Buf, size_t *N, int *Status)
{
...
bool
ItaniumPartialDemangler::partialDemangle(const char *MangledName)
{
...
static char *
printNode(const Node *RootNode, char *Buf, size_t *N)
{
    OutputStream S;
...
char *
ItaniumPartialDemangler::getFunctionBaseName(char *Buf, size_t *N) const
{
    if (!isFunction())
        return nullptr;
...
char *
ItaniumPartialDemangler::getFunctionDeclContextName(char *Buf, size_t *N) const
{
    if (!isFunction())
        return nullptr;
    const Node *Name = static_cast<const FunctionEncoding *>(RootNode)->getName();
...
char *
ItaniumPartialDemangler::getFunctionName(char *Buf, size_t *N) const
{
    if (!isFunction())
        return nullptr;
...
char *
ItaniumPartialDemangler::getFunctionParameters(char *Buf, size_t *N) const
{
    if (!isFunction())
        return nullptr;
...
char *
ItaniumPartialDemangler::getFunctionReturnType(char *Buf, size_t *N) const
{
    if (!isFunction())
        return nullptr;
...
char *
ItaniumPartialDemangler::finishDemangle(char *Buf, size_t *N) const
{
...
bool
ItaniumPartialDemangler::hasFunctionQualifiers() const
{
    assert(RootNode != nullptr && "must call partialDemangle()");
    if (!isFunction())
        return false;
...
bool
ItaniumPartialDemangler::isCtorOrDtor() const
{
...
bool
ItaniumPartialDemangler::isFunction() const
{
    assert(RootNode != nullptr && "must call partialDemangle()");
...
bool
ItaniumPartialDemangler::isSpecialName() const
{
    assert(RootNode != nullptr && "must call partialDemangle()");
